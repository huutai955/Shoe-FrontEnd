                ...
                <div className='flex items-center justify-between py-4 pl-2'>
                    ...
                    <ul className='list-none flex gap-6 text-base'>
                        ...
                        {isLogin ? <li className='cursor-pointer relative pr-2 popup'>Account
                            ...
                            <a href={`https://www.facebook.com/v18.0/dialog/oauth?client_id=${process.env.NEXT_PUBLIC_FACEBOOK_CLIENT_ID}&redirect_uri=${process.env.NEXT_PUBLIC_FACEBOOK_REDIRECT_URL}${lng}/login`}>Google</a>
                        </li>}
                    </ul>
                </div>
                {children}
